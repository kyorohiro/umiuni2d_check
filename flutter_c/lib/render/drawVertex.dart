...
class DrawVertexsObject extends RenderConstrainedBox {
  ...
  void drawSurface(PaintingContext context, Offset offset, Matrix4 mat) {
    ...
    sky.BlendMode transferMode = sky.BlendMode.color;
    ...
    sky.Vertices vertices = new sky.Vertices(vertexMode, verticesSrc, indices: indicies,textureCoordinates: textureCoordinates, colors: colors);
    context.canvas.drawVertices(vertices, transferMode, paint);
  }
}
/*
class ImageLoader {
